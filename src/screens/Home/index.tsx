    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.desc}>
          ...
          press the Guest Color button to answer. Your score is determined by
          the remaining time. When the time is up, then it&apos;s a game over!
